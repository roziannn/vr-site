...
export default function Hero() {
  return (
    <div className="flex flex-col items-center mt-10 lg:mt-20" id="hero">
      <motion.h1 variants={fadeIn("down", 0.2)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.8 }} className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
