  ...
  return (
    <div className="relative mt-40 border-b border-neutral-800 min-h-[800px]" id="features">
      <div className="text-center">
        ...
        <motion.h2 variants={fadeIn("left", 0.2)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.7 }} className="text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-10 tracking-wide">
          Easily build
      ...
      {/* feature items */}
      <motion.div variants={fadeIn("right", 0.2)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.7 }} className="flex flex-wrap mt-10 lg:mt-20">
